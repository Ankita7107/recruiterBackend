...
const getAllJobs = async (req, res) => {
  try {
    ...
    const jobs = await Job.find(filter)
      .populate('employer', 'companyName businessEmail hrPhone website address email mobile verified') // Get company name and contact details from Employer
...
const getJobById = async (req, res) => {
  try {
    const job = await Job.findById(req.params.id)
      .populate('employer', 'companyName firstName lastName email mobile businessEmail hrPhone website address verified');
